...
// Type: eBay.Service.Core.Soap.eBayPLUSPreferenceType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class eBayPLUSPreferenceType
  {
    ...
    private bool mListingPreference;
    private bool mListingPreferenceSpecified;
    ...
    {
      get => this.mListingPreference;
      set
      {
        this.mListingPreference = value;
        this.mListingPreferenceSpecified = true;
      }
    }
    ...
    {
      get => this.mListingPreferenceSpecified;
      set => this.mListingPreferenceSpecified = value;
    }

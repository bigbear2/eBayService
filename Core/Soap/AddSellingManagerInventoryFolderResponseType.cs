...
// Type: eBay.Service.Core.Soap.AddSellingManagerInventoryFolderResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class AddSellingManagerInventoryFolderResponseType : AbstractResponseType
  {

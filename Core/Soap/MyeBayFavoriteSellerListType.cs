...
// Type: eBay.Service.Core.Soap.MyeBayFavoriteSellerListType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class MyeBayFavoriteSellerListType
  {
    ...
    private MyeBayFavoriteSellerTypeCollection mFavoriteSeller;
    ...
    /// 
    /// </summary>
    [XmlElement("FavoriteSeller")]
    public MyeBayFavoriteSellerTypeCollection FavoriteSeller
    {
      get => this.mFavoriteSeller;
      set => this.mFavoriteSeller = value;
    }

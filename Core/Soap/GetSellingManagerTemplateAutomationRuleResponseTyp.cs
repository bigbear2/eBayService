...
// Type: eBay.Service.Core.Soap.GetSellingManagerTemplateAutomationRuleResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class GetSellingManagerTemplateAutomationRuleResponseType : AbstractResponseType
  {

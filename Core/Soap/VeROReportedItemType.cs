...
// Type: eBay.Service.Core.Soap.VeROReportedItemType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class VeROReportedItemType
  {
    ...
    {
      get => this.mItemStatusSpecified;
      set => this.mItemStatusSpecified = value;
    }
    ...
    {
      get => this.mItemReasonForFailure;
      set => this.mItemReasonForFailure = value;
    }

...
// Type: eBay.Service.Core.Soap.ReturnsDurationCodeTypeCollection
...
namespace eBay.Service.Core.Soap
{
  ...
  /// </summary>
  [Serializable]
  public sealed class ReturnsDurationCodeTypeCollection : CollectionBase
  {
    /// <summary>
    /// 
    /// </summary>
    ...
    {
      get => (ReturnsDurationCodeType) this.InnerList[index];
    ...
    /// <returns></returns>
    public int Add(ReturnsDurationCodeType item) => this.InnerList.Add((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public bool Contains(ReturnsDurationCodeType item) => this.InnerList.Contains((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public int IndexOf(ReturnsDurationCodeType item) => this.InnerList.IndexOf((object) item);
    ...
    /// </summary>
    /// <param name="item"></param>
    public void Remove(ReturnsDurationCodeType item) => this.InnerList.Remove((object) item);

...
// Type: eBay.Service.Core.Soap.DeleteSellingManagerTemplateAutomationRuleResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class DeleteSellingManagerTemplateAutomationRuleResponseType : AbstractResponseType
  {

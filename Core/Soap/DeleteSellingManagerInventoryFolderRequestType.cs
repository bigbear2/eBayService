...
// Type: eBay.Service.Core.Soap.DeleteSellingManagerInventoryFolderRequestType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class DeleteSellingManagerInventoryFolderRequestType : AbstractRequestType
  {

...
// Type: eBay.Service.Core.Soap.GetSellingManagerItemAutomationRuleResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class GetSellingManagerItemAutomationRuleResponseType : AbstractResponseType
  {

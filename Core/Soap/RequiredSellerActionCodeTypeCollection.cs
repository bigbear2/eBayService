...
// Type: eBay.Service.Core.Soap.RequiredSellerActionCodeTypeCollection
...
namespace eBay.Service.Core.Soap
{
  ...
  /// </summary>
  [Serializable]
  public sealed class RequiredSellerActionCodeTypeCollection : CollectionBase
  {
    /// <summary>
    /// 
    /// </summary>
    ...
    {
      get => (RequiredSellerActionCodeType) this.InnerList[index];
    ...
    /// <returns></returns>
    public int Add(RequiredSellerActionCodeType item) => this.InnerList.Add((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public int IndexOf(RequiredSellerActionCodeType item) => this.InnerList.IndexOf((object) item);
    ...
    /// </summary>
    /// <param name="item"></param>
    public void Remove(RequiredSellerActionCodeType item) => this.InnerList.Remove((object) item);

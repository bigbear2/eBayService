...
// Type: eBay.Service.Core.Soap.UploadSiteHostedPicturesResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class UploadSiteHostedPicturesResponseType : AbstractResponseType
  {
    private int mPictureSystemVersion;
    private bool mPictureSystemVersionSpecified;
    private SiteHostedPictureDetailsType mSiteHostedPictureDetails;
    ...
    {
      get => this.mSiteHostedPictureDetails;
      set => this.mSiteHostedPictureDetails = value;
    }
  }
}

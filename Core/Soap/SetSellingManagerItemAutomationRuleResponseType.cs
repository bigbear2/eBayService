...
// Type: eBay.Service.Core.Soap.SetSellingManagerItemAutomationRuleResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class SetSellingManagerItemAutomationRuleResponseType : AbstractResponseType
  {

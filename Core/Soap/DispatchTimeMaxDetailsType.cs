...
// Type: eBay.Service.Core.Soap.DispatchTimeMaxDetailsType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class DispatchTimeMaxDetailsType
  {
    ...
    private bool mExtendedHandling;
    private bool mExtendedHandlingSpecified;
    ...
    {
      get => this.mExtendedHandling;
      set
      {
        this.mExtendedHandling = value;
        this.mExtendedHandlingSpecified = true;
      }
    }
    ...
    {
      get => this.mExtendedHandlingSpecified;
      set => this.mExtendedHandlingSpecified = value;
    }

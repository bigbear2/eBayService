...
// Type: eBay.Service.Core.Soap.SellerDashboardAlertTypeCollection
...
namespace eBay.Service.Core.Soap
{
  ...
  /// </summary>
  [Serializable]
  public sealed class SellerDashboardAlertTypeCollection : CollectionBase
  {
    /// <summary>
    /// 
    /// </summary>
    ...
    {
      get => (SellerDashboardAlertType) this.InnerList[index];
    ...
    /// <returns></returns>
    public int Add(SellerDashboardAlertType item) => this.InnerList.Add((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public bool Contains(SellerDashboardAlertType item) => this.InnerList.Contains((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public int IndexOf(SellerDashboardAlertType item) => this.InnerList.IndexOf((object) item);
    ...
    /// </summary>
    /// <param name="item"></param>
    public void Remove(SellerDashboardAlertType item) => this.InnerList.Remove((object) item);

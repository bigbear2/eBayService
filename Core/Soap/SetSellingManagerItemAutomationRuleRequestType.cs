...
// Type: eBay.Service.Core.Soap.SetSellingManagerItemAutomationRuleRequestType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class SetSellingManagerItemAutomationRuleRequestType : AbstractRequestType
  {

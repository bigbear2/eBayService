...
// Type: eBay.Service.Core.Soap.UnitOfMeasurementType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class UnitOfMeasurementType
  {
    ...
    {
      get => this.mAlternateText;
      set => this.mAlternateText = value;
    }
    ...
    {
      get => this.mSuggestedText;
      set => this.mSuggestedText = value;
    }

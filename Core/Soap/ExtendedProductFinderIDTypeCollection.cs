...
// Type: eBay.Service.Core.Soap.ExtendedProductFinderIDTypeCollection
...
namespace eBay.Service.Core.Soap
{
  ...
  /// </summary>
  [Serializable]
  public sealed class ExtendedProductFinderIDTypeCollection : CollectionBase
  {
    /// <summary>
    /// 
    /// </summary>
    ...
    {
      get => (ExtendedProductFinderIDType) this.InnerList[index];
    ...
    /// <returns></returns>
    public int Add(ExtendedProductFinderIDType item) => this.InnerList.Add((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public int IndexOf(ExtendedProductFinderIDType item) => this.InnerList.IndexOf((object) item);
    ...
    /// </summary>
    /// <param name="item"></param>
    public void Remove(ExtendedProductFinderIDType item) => this.InnerList.Remove((object) item);

...
// Type: eBay.Service.Core.Soap.GetAdFormatLeadsResponseType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class GetAdFormatLeadsResponseType : AbstractResponseType
  {
    ...
    /// 
    /// </summary>
    [XmlElement("AdFormatLead")]
    public AdFormatLeadTypeCollection AdFormatLead
    {
      get => this.mAdFormatLead;
      set => this.mAdFormatLead = value;
    }
    ...
    {
      get => this.mAdFormatLeadCountSpecified;
      set => this.mAdFormatLeadCountSpecified = value;
    }
  }
}

...
// Type: eBay.Service.Core.Soap.AverageRatingDetailsType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class AverageRatingDetailsType
  {
    ...
    private bool mRatingCountSpecified;
    ...
    {
      get => this.mRatingCount;
      set
      {
        this.mRatingCount = value;
        this.mRatingCountSpecified = true;
      }
    }
    ...
    {
      get => this.mRatingCountSpecified;
      set => this.mRatingCountSpecified = value;
    }

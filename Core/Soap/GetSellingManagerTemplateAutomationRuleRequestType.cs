...
// Type: eBay.Service.Core.Soap.GetSellingManagerTemplateAutomationRuleRequestType
...
namespace eBay.Service.Core.Soap
{
  ...
  [Serializable]
  public class GetSellingManagerTemplateAutomationRuleRequestType : AbstractRequestType
  {

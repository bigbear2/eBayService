...
// Type: eBay.Service.Core.Soap.MultiLegShippingDetailsType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class MultiLegShippingDetailsType
  {
    ...
    {
      get => this.mSellerShipmentToLogisticsProvider;
      set => this.mSellerShipmentToLogisticsProvider = value;
    }
    ...
    {
      get => this.mLogisticsProviderShipmentToBuyer;
      set => this.mLogisticsProviderShipmentToBuyer = value;
    }

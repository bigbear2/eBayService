...
// Type: eBay.Service.Core.Soap.PerformanceDashboardTypeCollection
...
namespace eBay.Service.Core.Soap
{
  ...
  /// </summary>
  [Serializable]
  public sealed class PerformanceDashboardTypeCollection : CollectionBase
  {
    /// <summary>
    /// 
    /// </summary>
    ...
    {
      get => (PerformanceDashboardType) this.InnerList[index];
    ...
    /// <returns></returns>
    public int Add(PerformanceDashboardType item) => this.InnerList.Add((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public bool Contains(PerformanceDashboardType item) => this.InnerList.Contains((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public int IndexOf(PerformanceDashboardType item) => this.InnerList.IndexOf((object) item);
    ...
    /// </summary>
    /// <param name="item"></param>
    public void Remove(PerformanceDashboardType item) => this.InnerList.Remove((object) item);

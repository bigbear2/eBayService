...
// Type: eBay.Service.Core.Soap.URLDetailsType
...
namespace eBay.Service.Core.Soap
{
  ...
  {
    private URLTypeCodeType mURLType;
    private bool mURLTypeSpecified;
    private string mURL;
    ...
    {
      get => this.mURLTypeSpecified;
      set => this.mURLTypeSpecified = value;
    }

...
// Type: eBay.Service.Core.Soap.InternationalReturnsShipmentPayeeCodeType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class InternationalReturnsShipmentPayeeCodeType
  {
    ...
    {
      get => this.mInternationalReturnsShipmentPayee;
      set => this.mInternationalReturnsShipmentPayee = value;
    }

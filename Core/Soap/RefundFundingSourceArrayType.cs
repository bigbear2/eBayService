...
// Type: eBay.Service.Core.Soap.RefundFundingSourceArrayType
...
namespace eBay.Service.Core.Soap
{
  ...
  public class RefundFundingSourceArrayType
  {
    ...
    /// 
    /// </summary>
    [XmlElement("RefundFundingSource")]
    public RefundFundingSourceTypeCollection RefundFundingSource
    {
      get => this.mRefundFundingSource;
      set => this.mRefundFundingSource = value;
    }

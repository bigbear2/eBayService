...
// Type: eBay.Service.Core.Soap.WarrantyTypeDetailsTypeCollection
...
namespace eBay.Service.Core.Soap
{
  ...
  /// </summary>
  [Serializable]
  public sealed class WarrantyTypeDetailsTypeCollection : CollectionBase
  {
    /// <summary>
    /// 
    /// </summary>
    ...
    {
      get => (WarrantyTypeDetailsType) this.InnerList[index];
    ...
    /// <returns></returns>
    public int Add(WarrantyTypeDetailsType item) => this.InnerList.Add((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public bool Contains(WarrantyTypeDetailsType item) => this.InnerList.Contains((object) item);
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public int IndexOf(WarrantyTypeDetailsType item) => this.InnerList.IndexOf((object) item);
    ...
    /// </summary>
    /// <param name="item"></param>
    public void Remove(WarrantyTypeDetailsType item) => this.InnerList.Remove((object) item);
